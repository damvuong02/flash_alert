package com.rocket.template.base.app
...
import com.rocket.template.base.utils.SystemUtil
import com.rocket.template.base.ui.component.splash.SplashActivity
import com.rocket.template.base.ui.component.language.LanguageModel
...
//        aperoAdConfig.setAppsflyerConfig(appsflyerConfig);
        ...
        if (NoDoorAd.getInstance().mediationProvider == ITGAdConfig.PROVIDER_ADMOB) {
